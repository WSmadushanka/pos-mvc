...
public class CustomerController {
    ...
    public CustomerModel getCustomer(String custId, String qurey) throws SQLException {
        Connection connection = DBConnection.getInstance().getConnection();
    ...
    public String updateCustomer(CustomerModel customerModel) throws SQLException {
        ...
        String query = "UPDATE Customer SET CustTitle =?, CustName=?, DOB=?, salary=?, CustAddress=?, City=?, Province=?, WHERE CustID=?";
        PreparedStatement preparedStatement = connection.prepareStatement(query);
